...
cut_mask = get_central_cut_mask(mask, N_Voxel_add, VN)
phi_current = calc_phi(cut_mask)
"""
...
for iteration in range(max_iter):
    ...
    cut_mask = get_central_cut_mask(mask, N_Voxel_add, VN)
    actual_phi = np.sum(cut_mask) / domain_volume    
...
print(f"Combined binned mask size (excluding buffer): {cut_mask.shape}")
