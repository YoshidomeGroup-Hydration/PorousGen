...
print(f"Time taken for particle placement: {elapsed_time:.2f} seconds\n")

print("Starting binning")
start_time = time.time()
cut_mask_binned =binarize_and_binning(cut_mask)
print(f"Time taken for binning: {time.time() - start_time:.2f} seconds")
...
print(f"Time taken for volume fraction adjustment: {time.time() - start_time:.2f} seconds")
